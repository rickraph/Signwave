    ...
    with sr.Microphone() as source:
        ...
        while True:
            ...
            try:
                ...
                elif(a.lower() == 'add new sentence'):
                    new_sentence = input("Enter the new sentence: ")
                    new_gif = input("Enter the name of the new gif (without .gif extension): ")
                    with open('sentences.txt', 'a') as file:
                        file.write(new_sentence + '\n')
                    isl_gif.append(new_gif.lower())
